            ...
            @if(auth()->user()->role == 'super_admin')
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        <li class="active">
                            <a href="{{route("dashboard")}}"> صفحه ی اصلی  </a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        <li>
                            <a href="{{route("store.stores")}}"> لیست مغازه  ها</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        <li class="active">
                            <a href="{{route("Account.User.Users")}}"> لیست کاربران </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        <li class="active">
                            <a href="{{route('Account.Article.show')}}">  اضافه کردن مقاله  </a>
                        </li>
                        <li>
                            <a href="{{route('Account.Article.Articles')}}"> لیست  مقالات</a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
