...
<div class="col-lg-12 col-12 layout-spacing">
    <div class="statbox widget box box-shadow">
        <form action="{{route("Account.Slider.sliderImage")}}" method="POST" enctype="multipart/form-data" id="my-form">
            @csrf
            <div class="row mb-4">
                <div class="col">
                    <label for="name_id" class="d-block">  لینک اسلاید </label>
                    <input id="name_id" name="url" type="text" class="form-control" placeholder="  لینک ">
                </div>
                <div class="col">
